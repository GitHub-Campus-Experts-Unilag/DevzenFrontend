...
export const OutputHtmlPreview = ({inputValue,setOutputValue,outputValue}:OutputProps) => {
  ...
  return (
    <div className="sm:w-[50%]">
          ...
          <div ref={outputRef} className="sm:h-screen h-[50vh] overflow-auto w-full bg-[#1D1D1D] text-[#D7D7D7] p-4 focus:outline-none" dangerouslySetInnerHTML={{__html: inputValue}}/>
    </div>
  )
}
