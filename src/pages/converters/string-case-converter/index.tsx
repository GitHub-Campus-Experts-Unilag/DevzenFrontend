  ...
  return (
    <section className="max-w-[1280px] mx-auto">
      <p
        ...
        className={
          dropDown
            ? "overlay bg-black opacity-0 z-20 fixed h-screen w-full top-0 left-0 right-0"
            : "hidden"
        }
      ></p>
      <div className="bg-[#131313] px-6 tracking-tight overflow-hidden">
        <header className="mb-8">
          ...
          <p className="font-medium text-[#BDBDBD]">
            Enter your text to convert it to your desired case format.
          </p>
        </header>
